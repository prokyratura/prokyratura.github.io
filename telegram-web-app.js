...
<ul class="dropdown-menu"><li class=""><a href="?setln=en">English</a></li><li class="chosen "><a href="?setln=ru">Русский</a></li><li class="long "><a href="?setln=id">Bahasa Indonesia</a></li><li class="long "><a href="?setln=ms">Bahasa Melayu</a></li><li class=""><a href="?setln=de">Deutsch</a></li><li class=""><a href="?setln=es">Español</a></li><li class=""><a href="?setln=fr">Français</a></li><li class=""><a href="?setln=it">Italiano</a></li><li class=""><a href="?setln=nl">Nederlands</a></li><li class=""><a href="?setln=uz">O‘zbek</a></li><li class=""><a href="?setln=pl">Polski</a></li><li class="long "><a href="?setln=pt-br">Português (Brasil)</a></li><li class=""><a href="?setln=tr">Türkçe</a></li><li class=""><a href="?setln=be">Беларуская</a></li><li class=""><a href="?setln=uk">Українська</a></li><li class=""><a href="?setln=kk">Қазақша</a></li><li class=""><a href="?setln=ar">العربية</a></li><li class=""><a href="?setln=fa">فارسی</a></li><li class=""><a href="?setln=ko">한국어</a></li></ul></li><li class="navbar-twitter hidden-xs"><a href="https://twitter.com/telegram" target="_blank" data-track="Follow/Twitter" onclick="trackDlClick(this, event)"><i class="icon icon-twitter"></i> Twitter</a></li></ul>
<ul class="nav navbar-nav">
  ...
  <div class="side_blog">
    ...
    <div class="side_blog_entries">
      <a href="/blog/member-tags-disable-sharing-and-more/ru" class="side_blog_entry">
  <div class="side_blog_date">1 марта</div>
  <div class="side_blog_title">Теги участников, вход через Telegram, запрет на копирование в чатах, изменение GIF, время голосования</div>
</a><a href="/blog/crafting-android-design-and-more/ru" class="side_blog_entry">
  <div class="side_blog_date">9 фев.</div>
  <div class="side_blog_title">Новый дизайн для Android, передача прав на группу, изготовление подарков, цветные кнопки для ботов</div>
</a><a href="/blog/new-design-ai-summaries/ru" class="side_blog_entry">
...
<div class="tl_main_download_desktop_section">
  ...
  <div class="tl_main_recent_news_wrap tl_blog_list_page_wrap">
    ...
    <div class="tl_main_recent_news_cards clearfix">
      <a class="dev_blog_card_link_wrap" href="/blog/member-tags-disable-sharing-and-more/ru"><div class="dev_blog_card_wrap">
  <img class="dev_blog_card_image" src="https://telegram.org/file/400780400115/5/Cv5ZyIIoOC0.324347.jpg/9b317921d13d7c6dda" />
  <div class="dev_blog_card_alltext_wrap">
    <h4 class="dev_blog_card_title">Теги участников, авторизация через Telegram, запрет на копирование в чатах, изменение GIF, время голосования в опросах</h4>
    <div class="dev_blog_card_lead">В новой версии Telegram появились теги — текстовые отметки рядом с именем — для участников…</div>
  </div>
  <div class="dev_blog_card_date">1 марта 2026</div>
</div></a><a class="dev_blog_card_link_wrap" href="/blog/crafting-android-design-and-more/ru"><div class="dev_blog_card_wrap">
  <img class="dev_blog_card_image" src="https://telegram.org/file/400780400229/3/96ausyGOrFI.476954.jpg/0660bf9f92b06db07c" />
  <div class="dev_blog_card_alltext_wrap">
    <h4 class="dev_blog_card_title">Новый дизайн для Android, передача прав на группу, изготовление подарков, цветные кнопки для ботов</h4>
    <div class="dev_blog_card_lead">Сегодня мы представляем крупнейшее обновление интерфейса в истории Telegram для Android, систему…</div>
  </div>
  <div class="dev_blog_card_date">9 фев. 2026</div>
</div></a>
    </div>
  </div>
